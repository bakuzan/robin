...
import { SeriesTypes as _seriesTypes } from '../models/series-types.enum';
import { SeriesStatuses as _seriesStatuses } from '../models/series-statuses.enum';
import * as _regex from './regexes';
...
export const SeriesStatuses = _seriesStatuses;
export const Regexes = _regex;
